...
tiffName = '.\data\pollen1_crop_150x150x30.tif';
...
img3D = uint8((img3D-minInt)./(maxInt-minInt)*255); 
[z_length, x_length, y_length] = size(img3D);
load('.\data\RecordAxialY150Z3030_DMD.mat'); % load measurement matrix
...
% save CS file
targetfile = [cell2mat(splitName(3)),'_CS.tif'];
t = Tiff(targetfile,'w');
