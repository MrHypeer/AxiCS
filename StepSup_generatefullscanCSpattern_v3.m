...
% compared with v2 version, this code use DMDscan code to generate
% pattern@20221025 LIU Gan
...
data_path = '.\experiment20221024\yzTest\';
...
Point{1} = [DMDpoints_xy, Point{1}(:,3)*0.4];
...
Cali = zeros(17,1);
Amp = zeros(1,17);
pattern =  TrajectoryByPoint_withcor_stack40Scan(Point{1}, ...
    Amp, Cali, data_path, 'Fullscan_X1Y100Z30XY04Z04');
toc
